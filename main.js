window.alert('Seja bem vindo ao quiz Édipo rei ')
window.alert('Por favor, caso estiver jogando no celular, gire a tela do celular para melhor visualização ')
var quiz=document.getElementById("quiz");
var ques= document.getElementById("question");
var opt1=document.getElementById("option1");
var opt2=document.getElementById("option2");
var opt3=document.getElementById("option3");
var op10 =document.getElementsByClassName("option");
...
function V()
{         
	if(document.getElementById('butao').clicked == true)
	{
...
function nextques2()
{
	 var selected_ans= document.querySelector('input[class="next3"]:checked');


	if(selected_ans.value=="V")
		{f+=1}
